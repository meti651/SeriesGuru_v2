...
using SerieGuru_v2.Controllers;
...
namespace SerieGuru_v2
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<ITraktAuthentication, TraktAuthentication.TraktAuthentication>();
            services.AddSingleton<IAuthenticationController, AuthenticationController>();
            services.AddSingleton<ITheTvDbAuthentication, TheTvDbAuthentication>();
        }
